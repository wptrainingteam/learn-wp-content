...
As you can see in this [responsive images example](https://mdn.github.io/learning-area/html/multimedia-and-embedding/responsive-images/responsive.html), both the header image and the main content image are cropped when you switch to mobile. 
